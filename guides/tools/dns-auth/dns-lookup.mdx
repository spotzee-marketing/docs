...
This guide covers all supported types. For email-authentication-specific records, the [email health check guide](https://spotzee.com/docs/guides/tools/email-validation/email-health-check) audits MX, SPF (TXT), DKIM (TXT), DMARC (TXT), BIMI, and MTA-STS in a single scan. The [SPF lookup guide](https://spotzee.com/docs/guides/tools/dns-auth/spf-lookup) and [DMARC lookup guide](https://spotzee.com/docs/guides/tools/dns-auth/dmarc-lookup) cover those specific record types in depth.
</Accordion>
</AccordionGroup>
