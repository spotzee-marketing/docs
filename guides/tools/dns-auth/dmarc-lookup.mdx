...
This guide covers DMARC record syntax and the rollout path in depth. For a broader picture of your domain's authentication posture, the [email health check guide](https://spotzee.com/docs/guides/tools/email-validation/email-health-check) audits SPF, DKIM, DMARC, BIMI, MTA-STS, and blacklist status in one scan. Run both when setting up a new sending domain or diagnosing a deliverability problem.
</Accordion>
</AccordionGroup>
