...
This guide covers the generator in depth. For understanding an existing record, use the [DMARC lookup tool](https://spotzee.com/tools/dmarc-lookup/) and the [DMARC lookup guide](https://spotzee.com/docs/guides/tools/dns-auth/dmarc-lookup). For a full authentication audit covering SPF, DKIM, DMARC, BIMI, and MTA-STS in one scan, run the [email health check](https://spotzee.com/tools/email-health-check/).
</Accordion>
</AccordionGroup>
