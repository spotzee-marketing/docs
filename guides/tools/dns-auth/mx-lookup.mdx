...
This guide covers MX record structure and common failure patterns. For a full picture of your domain's email authentication posture — covering MX, SPF, DKIM, DMARC, BIMI, MTA-STS, and blacklist status — run the [email health check guide](https://spotzee.com/docs/guides/tools/email-validation/email-health-check) for the full audit walkthrough.
</Accordion>
</AccordionGroup>
