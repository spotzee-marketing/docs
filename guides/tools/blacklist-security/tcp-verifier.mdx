...
Read the in-depth [TCP port checker guide](https://docs.spotzee.com/guides/tools/blacklist-security/tcp-verifier) for common email and service port patterns, firewall diagnosis, and how TCP checks fit into a broader [SMTP server test](https://spotzee.com/tools/smtp-server-test/) workflow.
</Accordion>
</AccordionGroup>
