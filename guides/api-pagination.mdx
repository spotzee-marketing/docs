---
title: "Pagination"
description: "Cursor pagination, sort directions, and result counts for Main API list endpoints."
keywords: ["pagination", "cursor", "nextCursor", "prevCursor", "list", "sort"]
---
...
<Columns cols={2}>
  <Card title="Rate limits" icon="gauge" href="/guides/api-rate-limits">Stay under per-IP rate limits while paging.</Card>
