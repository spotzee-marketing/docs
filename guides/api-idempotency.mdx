...
```json
{
  ...
  "type": "https://spotzee.com/docs/main-api/errors#idempotency_key_mismatch",
...
| `409` | `idempotency_in_progress` | Original request still running. Retry after `Retry-After`. Main API only (once enforcement ships). |
